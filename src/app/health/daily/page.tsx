        ...
        <div className="xl:col-span-2 space-y-8 animate-in fade-in-50 duration-500">
              ...
              <div className="max-w-xl mx-auto space-y-6 rounded-3xl bg-white/30 dark:bg-black/10 p-5 md:p-6 backdrop-blur-md shadow-inner border border-white/20 dark:border-white/5">
                ...
                <div className="space-y-2.5">
                  <label className="text-xs font-black text-zinc-600 dark:text-zinc-400 uppercase tracking-widest pl-2 flex items-center justify-between">
                    {addType === "WORKOUT" ? "Nazwa Treningu" : "Co zjadłeś? (Opcjonalnie)"}
                  </label>
                  <input 
                    type="text" 
                    value={addTitle}
                    ...
                    placeholder={addType === "WORKOUT" ? "np. Chest Day, Push" : "np. Tosty, Sałatka"} 
                  />
                </div>

                {addType === "WORKOUT" && (
                  <div className="space-y-3 animate-in slide-in-from-bottom-4 duration-500">
                    <label className="text-xs font-black text-zinc-600 dark:text-zinc-400 uppercase tracking-widest pl-2">Lista ćwiczeń</label>
                ...
                {addType === "CALORIES" && (
                  <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
                    <label className="text-xs font-black text-zinc-600 dark:text-zinc-400 uppercase tracking-widest pl-2">Ilość kalorii</label>
                ...
                >
                  <Plus className="w-5 h-5" /> Dodaj wpis do Dziennika
                </button>
          ...
          <div className="bg-white/40 dark:bg-zinc-950/20 backdrop-blur-3xl rounded-[2.5rem] border border-white/50 dark:border-white/10 shadow-sm p-8">
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-6 flex items-center gap-2">
              <CalendarDays className="w-6 h-6 text-blue-500" /> Wpisy z {format(selectedDay, "dd.MM.yyyy")}
            </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-bold text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                  <Dumbbell className="w-4 h-4 text-emerald-500" /> Treningi
                </h4>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="bg-orange-500/10 text-orange-600 px-3 py-1 rounded-xl text-xs font-bold">Razem: {totalDayCalories} kcal</span>
                </div>
                {dayMeals.length === 0 ? (
